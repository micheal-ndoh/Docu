/*
  ...
  - You are about to drop the column `templateId` on the `Submission` table. All the data in the column will be lost.
...
-- Clear existing Better Auth data before migration
DELETE FROM "public"."Session";
DELETE FROM "public"."Account";

-- DropForeignKey
ALTER TABLE "public"."Submission" DROP CONSTRAINT "Submission_templateId_fkey";
...
-- AlterTable
ALTER TABLE "Submission" DROP COLUMN "templateId";
